...
Result::Result() : userId(0), attemptId(0), questionId(0), choice(0) {}

Result::Result(int questionId, char choice)
    : userId(0), attemptId(0), questionId(questionId), choice(choice) {}

Result::Result(int userId, int attemptId, int questionId, char choice)
    : userId(userId), attemptId(attemptId), questionId(questionId), choice(choice) {}
